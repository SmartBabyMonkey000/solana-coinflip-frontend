...
const AfterConnected = () => {
  ...
  const solOptions = ["0.05", "0.1", "0.25", "0.5", "1", "2", "4"];
  ...
  return (
    <div>
      ...
      <div className="flex justify-center flex-col items-center">
        ...
        <div
          className={`flex items-end coin ${flip ? (result === "Heads" ? "spin-heads" : "spin-tails") : null
            }`}
        >
          <div className="heads">
        ...
        <div className="grid  grid-flow-col justify-center gap-3 mt-8">
          {coinOptions.map((value, key) => (
            <button
              ...
              key={key}
              className={` uppercase rounded-md py-2 px-6 border-[1px] font-bold text-sm md:text-xl shadow-lg ${currentCoinOption === key ? "bg-yellow-700 px-10 py-5 font-bold text-white rounded rounded-tr-3xl rounded-bl-3xl" : 'bg-slate-500 px-10 py-5 font-bold text-white rounded rounded-tr-3xl rounded-bl-3xl'
                }`}
            >
              {value}
            </button>
        ...
        <div className="flex  flex-wrap grid-flow-col justify-center gap-3 mt-4">
        ...
        <button
          className={` h-12 w-32 md:h-16 md:w-48 ${loading ? "bg-gray-400 pointer-events-none h-16" : "bg-yellow-400 "
